    ...
    return (
      ...
      (o.$typeUrl === RequestBeginBlock.typeUrl ||
        ((o.hash instanceof Uint8Array || typeof o.hash === "string") &&
          ...
          (!o.byzantineValidators.length || Misbehavior.is(o.byzantineValidators[0]))))
    );
  },
    ...
    return (
      ...
      (o.$typeUrl === RequestBeginBlock.typeUrl ||
        ((o.hash instanceof Uint8Array || typeof o.hash === "string") &&
          ...
          (!o.byzantine_validators.length || Misbehavior.isAmino(o.byzantine_validators[0]))))
    );
  },
...
export const RequestDeliverTx = {
  ...
  is(o: any): o is RequestDeliverTx {
    return (
      o && (o.$typeUrl === RequestDeliverTx.typeUrl || o.tx instanceof Uint8Array || typeof o.tx === "string")
    );
  },
...
export const ResponseBeginBlock = {
  ...
  is(o: any): o is ResponseBeginBlock {
    return (
      ...
      (o.$typeUrl === ResponseBeginBlock.typeUrl ||
        (Array.isArray(o.events) && (!o.events.length || Event.is(o.events[0]))))
    );
  },
  isAmino(o: any): o is ResponseBeginBlockAmino {
    return (
      o &&
      (o.$typeUrl === ResponseBeginBlock.typeUrl ||
        (Array.isArray(o.events) && (!o.events.length || Event.isAmino(o.events[0]))))
    );
  },
...
export const ResponseCommit = {
  ...
  is(o: any): o is ResponseCommit {
    return (
      ...
      (o.$typeUrl === ResponseCommit.typeUrl ||
        ((o.data instanceof Uint8Array || typeof o.data === "string") && typeof o.retainHeight === "bigint"))
    );
  },
  isAmino(o: any): o is ResponseCommitAmino {
    return (
      o &&
      (o.$typeUrl === ResponseCommit.typeUrl ||
        ((o.data instanceof Uint8Array || typeof o.data === "string") && typeof o.retain_height === "bigint"))
    );
  },
...
export const VoteInfo = {
  ...
  isAmino(o: any): o is VoteInfoAmino {
    return (
      o &&
      (o.$typeUrl === VoteInfo.typeUrl ||
        (Validator.isAmino(o.validator) && typeof o.signed_last_block === "boolean"))
    );
  },
