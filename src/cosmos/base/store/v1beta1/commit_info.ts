...
export const StoreInfo = {
  ...
  isAmino(o: any): o is StoreInfoAmino {
    return (
      o && (o.$typeUrl === StoreInfo.typeUrl || (typeof o.name === "string" && CommitID.isAmino(o.commit_id)))
    );
  },
  ...
  is(o: any): o is CommitID {
    return (
      ...
      (o.$typeUrl === CommitID.typeUrl ||
        (typeof o.version === "bigint" && (o.hash instanceof Uint8Array || typeof o.hash === "string")))
    );
  },
