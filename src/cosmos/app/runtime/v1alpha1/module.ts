    ...
    return (
      ...
      (o.$typeUrl === Module.typeUrl ||
        (typeof o.appName === "string" &&
          ...
          (!o.overrideStoreKeys.length || StoreKeyConfig.is(o.overrideStoreKeys[0]))))
    );
  },
    ...
    return (
      ...
      (o.$typeUrl === Module.typeUrl ||
        (typeof o.app_name === "string" &&
          ...
          (!o.begin_blockers.length || typeof o.begin_blockers[0] === "string") &&
          ...
          (!o.export_genesis.length || typeof o.export_genesis[0] === "string") &&
          Array.isArray(o.override_store_keys) &&
          (!o.override_store_keys.length || StoreKeyConfig.isAmino(o.override_store_keys[0]))))
    );
  },
...
export const StoreKeyConfig = {
  ...
  isAmino(o: any): o is StoreKeyConfigAmino {
    return (
      o &&
      (o.$typeUrl === StoreKeyConfig.typeUrl ||
        (typeof o.module_name === "string" && typeof o.kv_store_key === "string"))
    );
  },
