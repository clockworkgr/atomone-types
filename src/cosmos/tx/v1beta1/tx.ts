...
export const TxRaw = {
  ...
  is(o: any): o is TxRaw {
    return (
      ...
      (o.$typeUrl === TxRaw.typeUrl ||
        ((o.bodyBytes instanceof Uint8Array || typeof o.bodyBytes === "string") &&
          (o.authInfoBytes instanceof Uint8Array || typeof o.authInfoBytes === "string") &&
          Array.isArray(o.signatures) &&
          (!o.signatures.length ||
            o.signatures[0] instanceof Uint8Array ||
            typeof o.signatures[0] === "string")))
  ...
  isAmino(o: any): o is TxRawAmino {
    return (
      o &&
      (o.$typeUrl === TxRaw.typeUrl ||
        ((o.body_bytes instanceof Uint8Array || typeof o.body_bytes === "string") &&
          (o.auth_info_bytes instanceof Uint8Array || typeof o.auth_info_bytes === "string") &&
          Array.isArray(o.signatures) &&
          (!o.signatures.length ||
            o.signatures[0] instanceof Uint8Array ||
            typeof o.signatures[0] === "string")))
...
export const TxBody = {
    ...
    return (
      ...
      (o.$typeUrl === TxBody.typeUrl ||
        (Array.isArray(o.messages) &&
          ...
          (!o.nonCriticalExtensionOptions.length || Any.is(o.nonCriticalExtensionOptions[0]))))
    );
  },
    ...
    return (
      ...
      (o.$typeUrl === TxBody.typeUrl ||
        (Array.isArray(o.messages) &&
          ...
          (!o.extension_options.length || Any.isAmino(o.extension_options[0])) &&
          Array.isArray(o.non_critical_extension_options) &&
          (!o.non_critical_extension_options.length || Any.isAmino(o.non_critical_extension_options[0]))))
    );
  },
  ...
  toAmino(message: TxBody): TxBodyAmino {
    ...
    if (message.nonCriticalExtensionOptions) {
      obj.non_critical_extension_options = message.nonCriticalExtensionOptions.map((e) =>
...
export const AuthInfo = {
  ...
  is(o: any): o is AuthInfo {
    return (
      ...
      (o.$typeUrl === AuthInfo.typeUrl ||
        (Array.isArray(o.signerInfos) && (!o.signerInfos.length || SignerInfo.is(o.signerInfos[0]))))
    );
  },
  isAmino(o: any): o is AuthInfoAmino {
    return (
      o &&
      (o.$typeUrl === AuthInfo.typeUrl ||
        (Array.isArray(o.signer_infos) && (!o.signer_infos.length || SignerInfo.isAmino(o.signer_infos[0]))))
    );
  },
...
export const ModeInfo_Multi = {
  ...
  is(o: any): o is ModeInfo_Multi {
    return (
      ...
      (o.$typeUrl === ModeInfo_Multi.typeUrl ||
        (Array.isArray(o.modeInfos) && (!o.modeInfos.length || ModeInfo.is(o.modeInfos[0]))))
    );
  },
  isAmino(o: any): o is ModeInfo_MultiAmino {
    return (
      o &&
      (o.$typeUrl === ModeInfo_Multi.typeUrl ||
        (Array.isArray(o.mode_infos) && (!o.mode_infos.length || ModeInfo.isAmino(o.mode_infos[0]))))
    );
  },
