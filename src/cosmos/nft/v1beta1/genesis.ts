...
export const GenesisState = {
    ...
    return (
      ...
      (o.$typeUrl === GenesisState.typeUrl ||
        (Array.isArray(o.classes) &&
          (!o.classes.length || Class.is(o.classes[0])) &&
          Array.isArray(o.entries) &&
          (!o.entries.length || Entry.is(o.entries[0]))))
    );
  },
  isAmino(o: any): o is GenesisStateAmino {
    return (
      ...
      (o.$typeUrl === GenesisState.typeUrl ||
        (Array.isArray(o.classes) &&
          (!o.classes.length || Class.isAmino(o.classes[0])) &&
          Array.isArray(o.entries) &&
          (!o.entries.length || Entry.isAmino(o.entries[0]))))
    );
  },
...
export const Entry = {
  ...
  is(o: any): o is Entry {
    return (
      o &&
      (o.$typeUrl === Entry.typeUrl ||
        (typeof o.owner === "string" && Array.isArray(o.nfts) && (!o.nfts.length || NFT.is(o.nfts[0]))))
    );
  },
  isAmino(o: any): o is EntryAmino {
    return (
      o &&
      (o.$typeUrl === Entry.typeUrl ||
        (typeof o.owner === "string" && Array.isArray(o.nfts) && (!o.nfts.length || NFT.isAmino(o.nfts[0]))))
    );
  },
